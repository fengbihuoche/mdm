...
def add_data_options(parser):
    ...
    group.add_argument("--dataset", default='humanml', choices=['humanml', 'kit', 'humanact12', 'uestc','Scene'], type=str,
...
def add_training_options(parser):
    ...
    group.add_argument("--save_interval", default=300, type=int,########
...
def add_sampling_options(parser):
    ...
    group.add_argument("--num_samples", default=3, type=int,
...
def generate_args():
    ...
    elif (args.input_text or args.text_prompt) and  cond_mode != 'scene':
        raise Exception('Arguments input_text and text_prompt should not be used for an action condition. Please use action_file or action_name.')'''
    return args
