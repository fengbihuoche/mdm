...
from data_loaders.tensors import t2m_collate,scene_collate
...
def get_dataset_class(name):
    ...
    elif name == "humanml": ############# text
        from data_loaders.humanml.data.dataset import HumanML3D
        return HumanML3D
    elif name == "kit":
        from data_loaders.humanml.data.dataset import KIT
        return KIT
    elif name=='Scene':  ##### text+scene
        from data_loaders.humanml.data.dataset import HumanML3D_Scene
        return HumanML3D_Scene
    else:
