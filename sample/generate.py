...
def main():
    ...
    if args.text_prompt != '':
        ...
        out_path=pjoin("/public/home/wangzy17/motion-diffusion-model/scene_generate/"+name)
    ...
    if is_using_data:
        ...
        pcs=[scene]*args.num_samples 
        
        is_t2m = any([args.input_text, args.text_prompt])
        if is_t2m:
            # t2m
            collate_args = [dict(arg, text=txt,pc=point) for arg, txt ,point in zip(collate_args, texts,pcs)]
        else:
            # a2m
    ...
    for rep_i in range(args.num_repetitions):
        ...
        print(sample.shape) ##########samples x 263 x 1 x 40
    ...
    all_motions = all_motions[:total_num_samples]  # [bs, njoints, , seqlen]
